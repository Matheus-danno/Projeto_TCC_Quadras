...
class AtividadeSala extends Model
{
    /** @use HasFactory<\Database\Factories\AtividadeSalaFactory> */
    use HasFactory;
    ...
    /**
     * Tempo decorrido desde a atividade, formatado de forma compacta em português

...
return [
    ...
    */
    ...
    | Isso facilita a definição de uma mensagem específica para uma
    | combinação de atributo e regra.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de idioma a seguir são usadas para trocar o placeholder do
    ...
    */
    ...
    'attributes' => [
        ...
        'cidade' => 'cidade',
        'estado' => 'estado',
        'diasUteisInicio' => 'horário de abertura (segunda a sexta)',
        'diasUteisFim' => 'horário de fechamento (segunda a sexta)',
        'sabadoInicio' => 'horário de abertura (sábado)',
        'sabadoFim' => 'horário de fechamento (sábado)',
        'domingoInicio' => 'horário de abertura (domingo)',
        'domingoFim' => 'horário de fechamento (domingo)',
        'excecaoData' => 'data',
        'excecaoDescricao' => 'descrição',
        'excecaoHoraAbertura' => 'horário de abertura',
        'excecaoHoraFechamento' => 'horário de fechamento',
        'pausaMotivo' => 'motivo',
        'pausaAte' => 'data',
    ],
